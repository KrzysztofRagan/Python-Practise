...
#When you create child class remember that it always go from left to right. When first class has some method (even if both classes have it, it will only be done by the first one unless there will be method super() used in child class)
...
#__mro__ shows order of going through parent and child classes
