...
#this class is an iterator thanks to __next__ method, but can not be iterated
...
#this class uses another class (iterator) and is iterable
class Combinations:
 
  def __init__(self, products, promotios, customers):
      self.products = products
      self.promotions = promotions
      self.customers = customers
